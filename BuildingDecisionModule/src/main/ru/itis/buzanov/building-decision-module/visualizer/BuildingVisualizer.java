...
public class BuildingVisualizer implements ActionListener, ItemListener, MouseListener {
	...
	private List<String> imageDirs = List.of("D:\\BuildingClassificator\\AOI_3_Paris_Train");
	private String[] imageIds;
	private Map<String, String> idToDir; // which data folder this image comes from
	private String currentImageId;
	private List<String> truthPaths = List.of("D:\\BuildingClassificator\\AOI_3_Paris_Train\\summaryData\\AOI_3_Paris_Train_Building_Solutions.csv");
	private String solutionPath = "D:\\BuildingClassificator\\BuildingClassificator\\paris_train_result";
	...
	private String bandTripletPath = "D:\\BuildingClassificator\\AOI_3_Paris_Train";
	private List<BandTriplet> bandTriplets;
	private BandTriplet currentBandTriplet;

	private Color textColor = Color.black;
	private Color tpBorderSolutionColor = new Color(255, 255, 255, 60);
	private Color tpFillSolutionColor = new Color(255, 255, 255, 60);
	private Color tpBorderTruthColor = new Color(84, 255, 0, 60);
	private Color tpFillTruthColor = new Color(84, 255, 0, 60);
	private Color fpBorderColor = new Color(255, 0, 0, 60);
	private Color fpFillColor = new Color(255, 0, 0, 60);
	private Color fnBorderColor = new Color(255, 0, 0, 60);
	private Color fnFillColor = new Color(255, 0, 0, 10);

	private void run() {
		idToSolutionPolygons = load(Collections.singletonList(solutionPath), false, null);
	...
	private Map<String, Polygon[]> load(List<String> paths, boolean truth, Map<String, Polygon[]> ids) {
		...
		log(" - Reading " + what + " from " + Arrays.toString(paths.toArray()) + " ...");
	...
	public void setupGUI(int W) {
		...
		showTruthCb = new JCheckBox("Отобразить реальные границы");
...
//		String line = null;
//		int lineNo = 0;
//		try (LineNumberReader lnr = new LineNumberReader(new FileReader(bandTripletPath))) {
//			while (true) {
//				line = lnr.readLine();
//				if (line == null) break;
//				lineNo++;
